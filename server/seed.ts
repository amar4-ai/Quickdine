...
const seedData = async()=>{
    try {
        ...
        console.log("Databse conneted. Clearing existing collections...");
        ...
        console.log("Creating resturants....")
...
console.log("Inserting resturants...");
const updatedResturantsData = resturantsData.map((rest, idx)=>{
    const {...restInfo} = rest;
    return {
        ...restInfo,
        owner: ownerUser._id,
...
await Resturant.insertMany(updatedResturantsData)
